...
def retrieve_client(stub):
    ...
    if response.CID == '0':
        print('Status: The database does not contains the client')
    else:
        print('Status: The client was found successfully')
...
def retrieve_product(stub):
    ...
    if response.PID == '0':
        print('Status: The database does not contains the product')
    else:
        print('Status: The product was found successfully')
    print(json.loads(response.data))
